$(function () {
    ...
    // % of Income
    const incData = {
        labels: ["Cash on Hand", "Saving Account", "E-wallet"],
        datasets: [
            {
                label: "Dataset 1",
                data: [40000, 120000, 5000],
                backgroundColor: ["#bff2fb", "#43a047", "#fe407a"],
            },
        ],
    };
    ...
    // % of Expense
    const expData = {
        labels: ["Grocery", "Education fee", "Savings"],
        datasets: [
            {
                label: "Dataset 1",
                data: [10000, 600000, 80000],
                backgroundColor: ["#bff2fb", "#43a047", "#fe407a"],
            },
        ],
    };
